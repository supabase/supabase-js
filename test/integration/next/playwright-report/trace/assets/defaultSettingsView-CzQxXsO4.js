...
function br(t, e) {
  ...
  function k() {
    ...
    if (o() === ']')
      return l(), { name: E.join('.'), jsonPath: E, op: '<truthy>', value: null, caseSensitive: !1 }
    const C = S()
    let A,
      O = !0
    if ((u(), o() === '/')) {
      ...
      if (
        ...
        try {
          ...
          C.status === 404 && (C = await fetch(`file?path=${encodeURIComponent(u)}`)),
            C.status >= 400 ? (d.content = `<Unable to read "${u}">`) : (d.content = await C.text())
        } catch {
...
class SS {
  generatePlaywrightRequestCall(e, n) {
    ...
    ;['delete', 'get', 'head', 'post', 'put', 'patch'].includes(c) ||
      ...
      e.headers.length &&
        l.push(
          `headers=${this.prettyPrintObject(
            Object.fromEntries(e.headers.map((d) => [d.name, d.value]))
          )}`
        )
    const u =
      l.length === 1
      ...
      for (const _ of k.items) {
        ...
        if (C.value === 'text') {
          if (!(A instanceof t.Scalar && typeof A.value == 'string')) {
            c.push({ message: 'Text value should be a string', range: u(_.value.range || k.range) })
            continue
          }
    ...
    if (((n = { full: '', normalized: '', immediate: [] }), !Ef(e))) {
      ...
      if (e instanceof HTMLInputElement && (e.type === 'submit' || e.type === 'button'))
        ...
        for (let o = e.firstChild; o; o = o.nextSibling)
          if (o.nodeType === Node.TEXT_NODE) (n.full += o.nodeValue || ''), (s += o.nodeValue || '')
          else {
...
const Dx = () => ({
  ...
  Xg = ['selected', 'checked', 'pressed', 'expanded', 'level', 'disabled', 'name', 'include-hidden']
Xg.sort()
function bi(t, e, n) {
  if (!e.includes(n))
    throw new Error(
...
function Fx(t, e) {
  ...
  for (const s of t)
    switch (s.name) {
      ...
      case 'disabled': {
        ls(s, [!0, !1]), as(s, ['<truthy>', '=']), (n.disabled = s.op === '<truthy>' ? !0 : s.value)
        break
      }
      case 'name': {
    ...
    return s < 0
      ...
      : this._cached(
          ...
          () => {
            ...
            if (c === '>') {
              const u = cl(e, o)
              return !u || !this._matchesSimple(u, l, o) ? !1 : this._matchesParents(u, n, s - 1, o)
            }
            if (c === '+') {
              const u = du(e, o)
              return !u || !this._matchesSimple(u, l, o) ? !1 : this._matchesParents(u, n, s - 1, o)
...
function hm(t, e, n) {
  ...
  try {
    ...
    const l = o[0],
      c = t.parseSelector(l)
    return { selector: l, selectors: o, elements: t.querySelectorAll(c, n.root ?? e.ownerDocument) }
  } finally {
    wf(), t._evaluator.end()
  }
}
...
class my {
  ...
  async _checkElementIsStable(e) {
    ...
    const c = () => {
      ...
      if (s) {
        if (!(k.x === s.x && k.y === s.y && k.width === s.width && k.height === s.height)) return !1
  ...
  strictModeViolationError(e, n) {
    ...
    return (
      s.length < n.length &&
        o.push(`
    ...`),
      this.createStacklessError(`strict mode violation: ${er(
        this._sdkLanguage,
        Tn(e)
...
class q_ {
  ...
  _onFocus(e) {
    var n, s
    e.isTrusted &&
      (this._ignoreOverlayEvent(e) || (s = (n = this._currentTool).onFocus) == null || s.call(n, e))
  }
  _onScroll(e) {
    var n, s
    e.isTrusted &&
  ...
  _onKeyUp(e) {
    var n, s
    e.isTrusted &&
      (this._ignoreOverlayEvent(e) || (s = (n = this._currentTool).onKeyUp) == null || s.call(n, e))
  }
  updateHighlight(e, n) {
    ;(this._lastHighlightedSelector = void 0),
      (this._lastHighlightedAriaTemplateJSON = 'undefined'),
  ...
  async performAction(e) {
    var n, s
    await ((s = (n = this._delegate).performAction) == null ? void 0 : s.call(n, e).catch(() => {}))
  }
  recordAction(e) {
    var n, s
...
function tE(t, e) {
  ...
  return {
    ...
    setAnchors: () => {
      for (const l of n) {
        const c = s.get(l)
        if (typeof c == 'object' && c.anchor && (ke(c.node) || $e(c.node))) c.node.anchor = c.anchor
        else {
...
class Lt extends Ny {
  ...
  toString(e, n, s) {
    ...
    for (const o of this.items)
      if (!Me(o)) throw new Error(`Map items must all be pairs; found ${JSON.stringify(o)} instead`)
    return (
      !e.allNullValues &&
...
class _s extends Lt {
  ...
  static from(e, n, s) {
    const { replacer: o } = s,
      l = new this(e)
    if (n && Symbol.iterator in Object(n))
      for (let c of n) typeof o == 'function' && (c = o.call(n, c, c)), l.items.push(Cf(c, null, s))
    return l
  }
}
...
`
  for (let _ = g; _ < u; ++_) {
    ...
    if ((A && (C = C.slice(0, -1)), C && E.length < d)) {
      const D = `Block scalar lines must not be less indented than their ${
...
function qE({ options: t }, { offset: e, source: n, end: s }, o) {
  ...
  l.source === '' && o(e, 'BAD_ALIAS', 'Alias cannot be an empty string'),
    l.source.endsWith(':') && o(e + n.length - 1, 'BAD_ALIAS', 'Alias ending in : is ambiguous', !0)
  const c = e + n.length,
    u = Gi(s, c, t.strict, o)
