      ...
      ;(C.version = '2.3.9'),
        ...
        (C.FieldRef.prototype.toString = function () {
          return (
            null == this._stringValue &&
              (this._stringValue = this.fieldName + C.FieldRef.joiner + this.docRef),
            this._stringValue
          )
        }),
        /*!
        ...
        (C.Set.prototype.union = function (e) {
          return e === C.Set.complete
            ...
            : e === C.Set.empty
            ? this
            : new C.Set(Object.keys(this.elements).concat(Object.keys(e.elements)))
        }),
        (C.idf = function (e, t) {
          var r = 0
         ...
         */ (C.tokenizer = function (e, t) {
          ...
          if (Array.isArray(e))
            return e.map(function (e) {
              return new C.Token(C.utils.asString(e).toLowerCase(), C.utils.clone(t))
            })
          for (
            var r = e.toString().toLowerCase(), n = r.length, i = [], s = 0, o = 0;
            s <= n;
            s++
          ) {
            var a = s - o
            if (r.charAt(s).match(C.tokenizer.separator) || s == n) {
              if (a > 0) {
                ...
                ;(u.position = [o, a]), (u.index = i.length), i.push(new C.Token(r.slice(o, s), u))
              }
              o = s + 1
            }
          }
         ...
         */ (C.stemmer =
          ...
          (_ = function (e) {
            ...
            return (
              ...
              (i = b).test(e) &&
                ((t = (_ = i.exec(e))[1]), (r = _[2]), (i = c).test(t) && (e = t + o[r])),
              (i = S).test(e) &&
                ((t = (_ = i.exec(e))[1]), (r = _[2]), (i = c).test(t) && (e = t + a[r])),
              (s = Q),
              (i = k).test(e)
                ? ((t = (_ = i.exec(e))[1]), (i = h).test(t) && (e = t))
                : s.test(e) && ((t = (_ = s.exec(e))[1] + _[2]), (s = h).test(t) && (e = t)),
              (i = O).test(e) &&
                ((t = (_ = i.exec(e))[1]),
                (s = d),
                (u = T),
        ...
        (C.TokenSet.fromArray = function (e) {
          for (var t = new C.TokenSet.Builder(), r = 0, n = e.length; r < n; r++) t.insert(e[r])
        ...
        (C.TokenSet.fromFuzzyString = function (e, t) {
          for (var r = new C.TokenSet(), n = [{ node: r, editsRemaining: t, str: e }]; n.length; ) {
            var i = n.pop()
            if (i.str.length > 0) {
              var s,
                o = i.str.charAt(0)
            ...
            if (0 != i.editsRemaining) {
              ...
              if (i.str.length > 1) {
                ...
                h in i.node.edges
                  ...
                  n.push({ node: l, editsRemaining: i.editsRemaining - 1, str: c + i.str.slice(2) })
              }
            }
          }
          return r
        ...
        (C.TokenSet.fromString = function (e) {
          for (var t = new C.TokenSet(), r = t, n = 0, i = e.length; n < i; n++) {
            var s = e[n],
              o = n == i - 1
        ...
        (C.TokenSet.prototype.toString = function () {
          ...
          for (
            var e = this.final ? '1' : '0', t = Object.keys(this.edges).sort(), r = t.length, n = 0;
            n < r;
            n++
          ) {
            var i = t[n]
        ...
        (C.TokenSet.prototype.intersect = function (e) {
          for (
            var t = new C.TokenSet(), r = void 0, n = [{ qNode: e, output: t, node: this }];
            n.length;
              ...
              for (var l = i[u], c = 0; c < a; c++) {
                ...
                if (h == l || '*' == l) {
                  ...
                  h in r.output.edges
                    ...
                    : (((y = new C.TokenSet()).final = p), (r.output.edges[h] = y)),
        ...
        (C.Index.prototype.query = function (e) {
                ...
                for (y = 0; y < u.fields.length; y++) {
                  ...
                  if (
                    (u.presence == C.Query.presence.REQUIRED &&
                      ((c = c.union(b)), void 0 === s[R] && (s[R] = C.Set.complete)),
                    ...
                    if (
                      ...
                      for (var S = 0; S < L.length; S++) {
                        var k,
                          ...
                          P = w[Q]
                        void 0 === (k = r[O]) ? (r[O] = new C.MatchData(v, R, P)) : k.add(v, R, P)
                      }
                      i[E] = !0
                    }
                  } else void 0 === o[R] && (o[R] = C.Set.empty), (o[R] = o[R].union(b))
                }
              }
            }
          ...
          for (a = 0; a < I.length; a++) {
            ...
            if (T.contains(D) && !_.contains(D)) {
              ...
              if (void 0 !== (A = F[D])) (A.score += q), A.matchData.combine(r[N])
              else {
        ...
        (C.Builder.prototype.createFieldVectors = function () {
          for (
            ...
            for (
              ...
              void 0 === n[g]
                ? ((y = C.idf(this.invertedIndex[g], this.documentCount)), (n[g] = y))
                : (y = n[g]),
                (m =
                  (y * ((this._k1 + 1) * x)) /
        ...
        (C.Builder.prototype.createTokenSet = function () {
          this.tokenSet = C.TokenSet.fromArray(Object.keys(this.invertedIndex).sort())
        }),
            ...
            for (var s = 0; s < i.length; s++) {
              ...
              for (var u = 0; u < a.length; u++) {
                ...
                null == this.metadata[n][o][l]
                  ...
                  : (this.metadata[n][o][l] = this.metadata[n][o][l].concat(e.metadata[n][o][l]))
              }
            }
          }
        }),
        ...
        (C.Query.prototype.isNegated = function () {
          for (var e = 0; e < this.clauses.length; e++)
            if (this.clauses[e].presence != C.Query.presence.PROHIBITED) return !1
          return !0
        }),
        ...
        (C.QueryLexer.prototype.sliceString = function () {
          ...
          return (
            e.push(this.str.slice(t, this.pos)), (this.escapeCharPositions.length = 0), e.join('')
          )
        }),
        ...
        (C.QueryLexer.lexField = function (e) {
          return e.backup(), e.emit(C.QueryLexer.FIELD), e.ignore(), C.QueryLexer.lexText
        }),
        (C.QueryLexer.lexTerm = function (e) {
          if ((e.width() > 1 && (e.backup(), e.emit(C.QueryLexer.TERM)), e.ignore(), e.more()))
            return C.QueryLexer.lexText
        }),
        (C.QueryLexer.lexEditDistance = function (e) {
          return (
            e.ignore(), e.acceptDigitRun(), e.emit(C.QueryLexer.EDIT_DISTANCE), C.QueryLexer.lexText
          )
        }),
        (C.QueryLexer.lexBoost = function (e) {
          return e.ignore(), e.acceptDigitRun(), e.emit(C.QueryLexer.BOOST), C.QueryLexer.lexText
        }),
        ...
        (C.QueryLexer.lexText = function (e) {
          for (;;) {
            ...
            if (92 != t.charCodeAt(0)) {
              ...
              if ('^' == t)
                return e.backup(), e.width() > 0 && e.emit(C.QueryLexer.TERM), C.QueryLexer.lexBoost
              if ('+' == t && 1 === e.width())
                return e.emit(C.QueryLexer.PRESENCE), C.QueryLexer.lexText
              if ('-' == t && 1 === e.width())
                return e.emit(C.QueryLexer.PRESENCE), C.QueryLexer.lexText
              if (t.match(C.QueryLexer.termSeparator)) return C.QueryLexer.lexTerm
  ...
  function (e, t, r) {
            ...
            n.forEach(function (t) {
              e.querySelectorAll(t.selector).forEach(function (e) {
                e.dataset.hasInstance ||
                  (new t.constructor({ el: e }), (e.dataset.hasInstance = String(!0)))
              })
            })
          }),
          e
    ...
    var h = (function (e) {
        function t(t) {
          ...
          return (
            (r.field = n), (r.results = i), (r.base = r.el.dataset.base + '/'), r.bindEvents(), r
          )
        }
        return (
          c(t, e),
            ...
            if (this.loadingState == o.Idle && !this.data) {
              ...
              t
                ? fetch(t)
                    ...
                    .then(function (t) {
                      ;(e.data = t), (e.index = l.Index.load(t.index)), e.setLoadingState(o.Ready)
                    })
                    .catch(function (t) {
          ...
          (t.prototype.updateResults = function () {
            if (
              ...
              ((this.results.textContent = ''), this.query && this.index && this.data)
            ) {
              var e = this.index.search('*' + this.query + '*')
              0 === e.length && (e = this.index.search('*' + this.query + '~1*'))
          ...
          (t.prototype.setHasFocus = function (e) {
            this.hasFocus != e &&
              ...
              e ? (this.setQuery(''), (this.field.value = '')) : (this.field.value = this.query))
          }),
          ...
          (t.prototype.setCurrentResult = function (e) {
            ...
            if (t) {
              ...
              (t = this.results.querySelector(1 == e ? 'li:first-child' : 'li:last-child')) &&
          ...
          (t.prototype.bindEvents = function () {
            ...
            this.results.addEventListener('mousedown', function () {
              ...
              this.field.addEventListener('keydown', function (t) {
                13 == t.keyCode || 27 == t.keyCode || 38 == t.keyCode || 40 == t.keyCode
                  ? ((e.preventPress = !0),
                    t.preventDefault(),
                    13 == t.keyCode
                      ? e.gotoCurrentResult()
              ...
              document.body.addEventListener('keydown', function (t) {
                t.altKey ||
                  t.ctrlKey ||
                  t.metaKey ||
                  (!e.hasFocus && t.keyCode > 47 && t.keyCode < 112 && e.field.focus())
              })
          }),
          t
        )
      ...
      v = (function (e) {
        ...
        return (
          ...
          (t.prototype.onResize = function () {
            ...
            var i = new CustomEvent('scroll', { detail: { scrollTop: y.instance.scrollTop } })
            this.onScroll(i)
          }),
        ...
        return (
          ...
          (t.prototype.createGroups = function () {
            ...
            if (!(e.length < 2)) {
              ...
              this.groups = []
              for (var r = 0; r < e.length; r++) this.groups.push(new x(e[r], t[r]))
            }
          }),
    ...
    i(h, '#tsd-search'),
      ...
      i(w, '.tsd-signatures'),
      i(_, 'a[data-toggle]'),
      F.isSupported() ? i(F, '#tsd-filter') : document.documentElement.classList.add('no-filter')
    var N = new a()
