...
describe("custom encoder and decoder", () => {
  ...
  it("allows custom encoding when using WebSocket transport", () => {
    ...
    socket = new Socket("wss://example.com/socket", {transport: WebSocket, encode: encoder})
  ...
  it("allows custom decoding when using WebSocket transport", () => {
    ...
    socket = new Socket("wss://example.com/socket", {transport: WebSocket, decode: decoder})
