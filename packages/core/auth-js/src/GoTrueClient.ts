...
export default class GoTrueClient {
  ...
  /**
   * Log in an OpenID Connect user.
   * @type OpenIDConnectCredentials
   * @param id_token A valid idtoken that was returned by the provider.
   * @param nonce The nonce of the user. The nonce is a random value generated by the developer (= yourself) before the initial grant is started. You should check the OpenID Connect specification for details. https://openid.net/developers/specs/
   * @param provider One of the providers supported by GoTrue.
   * @param client_id A valid client_id that was returned by the provider.
   * @param issuer A valid issuer that was returned by the provider.
  */
   ...
   * Log in an OpenID Connect user.
   * @type OpenIDConnectCredentials
   * @param IDToken A valid idtoken that was returned by the provider.
   * @param nonce The nonce of the user. The nonce is a random value generated by the developer (= yourself) before the initial grant is started. You should check the OpenID Connect specification for details. https://openid.net/developers/specs/
   * @param provider One of the providers supported by GoTrue.
   * @param clientID A valid client_id that was returned by the provider.
   * @param issuer A valid issuer that was returned by the provider.
  */
